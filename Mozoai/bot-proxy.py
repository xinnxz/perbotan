...
class MozoAI:
    ...
    def claim(self, data, tap_times, multitap_point, proxy_info):
    ...
    def turbo_claim(self, data, game_id, tap_times, multitap_point, proxy_info):
        url = "https://api.mozo.xyz/v1/ai/tap/claim/"
    ...
    def recover_energy(self, data, proxy_info):
    ...
    def lightning_tap(self, data, proxy_info):
    ...
    def main(self):
        while True:
            ...
            for no, account in enumerate(accounts):
                ...
                try:
                    while True:
                        info = self.info(data=data, proxy_info=proxy_info).json()
                        ...
                        if tap_times > 0:
                            ...
                            try:
                                ...
                                recover_energy = self.recover_energy(
                ...
                try:
                    while True:
                        ...
                        info = self.info(data=data, proxy_info=proxy_info).json()
                        multitap_point = info["data"]["multitap_point"]
                        lightning_tap = self.lightning_tap(
                            data=data, proxy_info=proxy_info
                        ).json()
